...
import { useSelector, useDispatch } from "react-redux"; // used to access the redux store
...
function CartSummary() {
  ...
  // to show cart items in the page
        ...
        >
          ...
          <div className="p-2 mx-3" style={{ width: "100%" }}>
            <div className="d-flex justify-content-between align-items-center">
              ...
              <h4>
                {/*! = not null says quantity is not null and then checks the value */}
